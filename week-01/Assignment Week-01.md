...
### After exploring each website, write a short summary analyzing the elements you liked and disliked, and explaining why. Be sure to include specific examples and links from the websites to support your analysis.
