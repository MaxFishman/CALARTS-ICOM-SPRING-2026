...
- **Servers**: Types of servers, client-server architecture, request/response cycle
- **Front End Development**: HTML, CSS, JavaScript, browser-side code
- **Back End Development**: Server-side programming, databases, APIs
...
- Network panel for monitoring requests and performance
- Application/Storage panel for viewing browser storage
- Performance and Lighthouse audits
